...
export function ProjectsTable({
  ...
  const openProjectUrl = useCallback((slug: string) => {
    if (!slug) return;
    window.open(
      `https://arena.colosseum.org/projects/explore/${slug}`,
      "_blank"
    );
  }, []);
            ...
            <div className="flex items-center justify-center gap-1">
              ...
              {(project.repoLink || project.github_url) && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center h-7 w-7 p-0 hover:bg-gray-800 rounded-md transition-colors"
              ...
              {project.slug && (
                <a
                  ...
                  title="View on Arena"
                >
                  <svg width="12" height="12" viewBox="0 0 918 918" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-gray-500">
                    <rect x="17.1494" y="17.1494" width="883.699" height="883.699" rx="49.4307" stroke="currentColor" strokeWidth="34.2988"/>
                    <path fillRule="evenodd" clipRule="evenodd" d="M740.451 194.414H177.547V263.005H740.451V194.414ZM684.763 316.249H233.114V384.839H684.763V316.249ZM424.644 438.105H493.235V739.306H424.644V438.105ZM356.057 438.105H287.467V739.306H356.057V438.105ZM561.883 438.105H630.473V739.306H561.883V438.105Z" fill="currentColor"/>
                  </svg>
                </a>
              )}
            </div>
            ...
            <TableHeader>
              <TableRow className="h-12 border-b-2">
                ...
                <TableHead className="w-[100px] text-center text-sm py-2">
                  <button
                    className="w-full font-semibold hover:text-blue-400 transition-colors group"
                ...
                <TableHead className="w-[80px] text-center text-sm py-2">
                  <button
                    className="w-full font-semibold hover:text-red-400 transition-colors group"
                ...
                <TableHead className="w-[70px] text-center text-sm py-2">
                  <button
                    className="w-full font-semibold hover:text-green-400 transition-colors group"
